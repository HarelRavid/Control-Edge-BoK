...
PDF files are useful for presentation but poor as the primary source for AI review, collaborative editing and version control. This repository therefore treats UTF-8 Markdown and plain text as the source of truth. Original PDF and DOCX files are retained only under each episode's `archive/` folder.

## Current status

Episodes 1-9 are complete in Hebrew and English. Episode 10 is planned as **Process Control and PID**.
...
- Edit `full.he.md` and `full.en.md`; regenerate derived `.txt` exports after changes.
...
זהו מאגר טקסטואלי דו-לשוני לסדרת הפודקאסט **Control Edge**. קובצי Markdown ו-TXT הם מקור העבודה. קובצי PDF ו-DOCX נשמרים בארכיון בלבד כדי לאפשר השוואה לתוצר המקורי.
